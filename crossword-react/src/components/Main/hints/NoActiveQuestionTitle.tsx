...
export const NoActiveQuestionTitle = () => {
  ...
  if (answeredQuestionsAmount) {
    return <div className="hints_wrapper"><h4>Pasirinkite kitą klausimą</h4></div>;
  }

  return <div className="hints_wrapper"><h4>Norint pradėti, spausk ant bet kurio paslėpto žodžio</h4></div>;
};
