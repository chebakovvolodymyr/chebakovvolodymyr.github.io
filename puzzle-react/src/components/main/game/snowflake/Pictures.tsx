...
export const Pictures: FC<PicturesProps> = ({snowflakes, setDroppedTitle, droppedTitles, toogleCheckbox, checkedCheckboxes, isGameOver}) => {
    return (
        <div className="pictures">
            {snowflakes.map(snowflake => (
                <Picture 
                    ...
                    title={droppedTitles.find(title => title.attachedCloudId === snowflake.id)?.title}
