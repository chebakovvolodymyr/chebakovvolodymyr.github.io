        ...
        <header>
            {isGameOver ? (
                ...
                <div className="question_title">
                    <span>
                    Vėjo iššūkis. Pagal pateiktą orų prognozę vėjų rožėje pažymėk, kokių krypčių numatomas vėjas, parink prognozuojamą vėjo greitį atitinkančią nuotrauką ir spausk „Pateikti“.
                    </span>
                </div>
            )}
